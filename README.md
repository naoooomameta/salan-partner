...
- [x] 収益モデル：パートナー目線で反映済み（募集枠5名・1名あたり担任生徒40名。月謝45,000円×40名＝月180万円、パートナー収益 年間約820万円／月換算約68万円）。本部側の収益率・金額（ロイヤリティ率等）と費用単価はサイト非公開とし、面談で書面提示する方針。公開前に最終数値の承認を取ること
